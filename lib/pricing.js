...
//
// CALIBRATION. The card is fitted to one real job:
//
//   Barrie, ~45km from Midland, 15 players, 3 photos each  ->  $175
//   base 70 + (15 x 6) + ((45 - 20) x 0.60) = 70 + 90 + 15 = 175
//
// One data point cannot pin down four levers -- several different cards hit
// $175 on that job and diverge wildly on a 40-player tournament an hour away.
// Check it against a few more real jobs before trusting it on anything far
// from the anchor.
